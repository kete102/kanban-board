...
export const BoardsContainer = () => {
  ...
  return (
    <div className="mt-2 h-full w-full p-4">
      {boards.map((board: Board) => (
        <div className="group relative col-span-12 max-w-xs rounded-2xl border border-solid border-gray-200 p-4 shadow-none transition-all duration-300 hover:shadow-lg hover:shadow-gray-400 md:col-span-6 lg:col-span-3 xl:p-7">
          <h4 className="mb-2 text-xl font-semibold capitalize text-gray-100 transition-all duration-500 group-hover:text-gray-50">
            {board.boardTitle}
          </h4>
          <p className="text-md mb-5 font-normal leading-5 text-gray-400 transition-all duration-500">
